...
public class ManagerDomainServiceImpl implements ManagerDomainService {
    ...
    @Override
    public ManagerDomainModel findManagerByPublicId(String managerUuid) {
        return managerDepartmentToManagerDomainModelMapper.mapManagerEntityToManagerDomainModel(
